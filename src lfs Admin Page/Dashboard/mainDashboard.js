...
import {Link ,BrowserRouter as Route,Switch,useRouteMatch,Redirect} from 'react-router-dom';
        ...
        <div>
            <div className="w3-top">
                <div className="w3-bar w3-white w3-card" id="myNavbar">
                    <button onClick={() => setNavOpen(true)} className="w3-bar-item w3-button w3-left"  >
                        <MaterialIcon icon="menu" size={25}/>
                    </button>
                    <button className="w3-bar-item w3-button w3-wide">LOGO</button>
                ...
                <nav className="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left" style={navStyle()}>
                    <button onClick={() => setNavOpen(false)} className="w3-bar-item w3-button w3-large w3-padding-16">Close ×</button>
